...
from .loss_lid import loss_lid, loss_lid_cos, loss_lid_general, loss_consistency, loss_consistency_ws

__all__ = ('loss_jocor', 'loss_structrue', 'loss_coteaching', 'NTXentLoss', 'elr_loss', 'elr_plus_loss'
           'SCELoss', 'GCELoss', 'DMILoss', 'CE_SR', 'Mixup', 'GJSLoss', 'loss_CR', 'loss_lid',
           'loss_lid_cos', 'loss_lid_general', 'loss_consistency', 'loss_consistency_ws')